...
(function($){
    ...
    $.fn.dragBlankQuiz = function( options ){
        ...
        var baseSettings = $.extend({
            ...
            answerHeading             : ' Cevapları Boşlukların Üzerine Sürükleyip Bırakınız.!',
            messageCorrect            : 'Doğru!',
            messageIncorrect          : 'Yanlış, bilemediniz',
            ...
            scoreMessagePattern       : 'Quiz bitti! %SCORE% kere yanlış tahminde bulundunuz.',
            fakeAnswers               : null,
